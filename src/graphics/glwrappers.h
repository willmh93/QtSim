...
public:
    ...
    void setup_from_source(QString shader_source, GlContext* surface);
...
public:
    ...
    QOpenGLExtraFunctions* gl() { return gl43; }
private:
    //OpenGL context
    QOpenGLContext *m_context = nullptr;        //will be deleted automatically
    //OpenGL extra functions
    QOpenGLExtraFunctions* gl43 = nullptr;  //should't delete this!
};
