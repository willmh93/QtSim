...
SIM_DECLARE(AnnoyingRacing, "My Projects", "Annoying Racing")
...
void AnnoyingRacing_Project::projectPrepare()
{
    ...
    create<AnnoyingRacing_Scene>(panel_count)->mountTo(layout);
}

/// Scene ///

void AnnoyingRacing_Scene::sceneAttributes(Input* options)
{
